...
module.exports = ({ numberOfStars=60, starScalingFactor=115 }) => {
    ...
    let regularStarIntervalId
    regularStarIntervalId = setInterval(() => {
    ...
    let shootingStartIntervalId 
    shootingStartIntervalId = setInterval(() => {
        if (!(sky && sky.parentElement)) {
            // kill this interval if the parent is deleted
