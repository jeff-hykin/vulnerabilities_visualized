...
},{}],"../../node_modules/gun/browser.js":[function(require,module,exports) {
module.exports = require('./gun.js');
},{"./gun.js":"../../node_modules/gun/gun.js"}],"../../node_modules/gun/lib/open.js":[function(require,module,exports) {
...
},{"../gun":"../../node_modules/gun/gun.js"}],"../../node_modules/gun/lib/load.js":[function(require,module,exports) {
var Gun = typeof window !== "undefined" ? window.Gun : require('../gun');
...
},{"../gun":"../../node_modules/gun/gun.js","./open":"../../node_modules/gun/lib/open.js"}],"../code/tools/gun_case.js":[function(require,module,exports) {
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var silentConsole = new Proxy(realConsole, {
  get: function get(realConsole, key) {
  ...
  set: function set(realConsole, key, newValue) {
    if (key == "log" || key == "debug") {
      return;
    }
...
var insideOfBrowser = typeof window != "undefined";
...
var nodeFromKeylist = function nodeFromKeylist(db, keyList) {
  var endNode = db;
...
var wrapper = function wrapper() {
  var gun = Gun.apply(void 0, arguments);
  var db = gun.get("@");
  var gunCase = {
    gun: gun,
    get: function get(keyList) {
      ...
      var _shallow$ref = _objectSpread({
        shallow: false
      }, ref),
          shallow = _shallow$ref.shallow;

      var node = nodeFromKeylist(db, keyList);
      ...
      if (shallow) {
        ...
        var getSubgraph = function getSubgraph(node) {
          return new Promise(function (resolve, reject) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        for (_i = 0, _Object$entries = Object.entries(value); _i < _Object$entries.length; _i++) {
                          _loop();
                        }
        ...
        return getSubgraph(node).then( // once the subgraph is done filling up valueObject, just return the original node value
        function (value) {
          return valueObject.get(Gun.node.soul(node));
        });
      }
    },
    keys: function keys(keyList) {
      var node = nodeFromKeylist(db, keyList);
      return new Promise(function (resolve, reject) {
        return node.once(function (object) {
          return resolve(Object.keys(object));
        });
      });
    },
    set: function set(keyList, value) {
      ...
      var node = nodeFromKeylist(db, keyList);
      return new Promise(function (resolve, reject) {
        return node.put(_defineProperty({}, last, value), function (acknowledgement) {
          acknowledgement.err && reject(acknowledgement.err);
          resolve(true);
        });
      });
    },
    merge: function merge(keyList, value) {
      var node = nodeFromKeylist(db, keyList);
      return new Promise(function (resolve, reject) {
        return node.put(value, function (acknowledgement) {
          acknowledgement.err && reject(acknowledgement.err);
          resolve(true);
        });
      });
    },
    delete: function _delete(keyList, value) {
      var last = keyList.pop();
      var node = nodeFromKeylist(db, keyList);
      return new Promise( // get the current value
      function (resolve, reject) {
        return node.once(function (value) {
          // delete only the one key, keep everything else
          delete value[last]; // set the value to be everything except the new key

          node.put(value, function (acknowledgement) {
            acknowledgement.err && reject(acknowledgement.err);
            resolve(true);
          });
        });
    ...
    connect: function connect(keyList1, keyList2) {
      var last = keyList1.pop();
      var parentNode = nodeFromKeylist(db, keyList1);
      var node = nodeFromKeylist(db, keyList2);
      return new Promise(function (resolve, reject) {
        return node.put(_defineProperty({}, last, node), function (acknowledgement) {
          acknowledgement.err && reject(acknowledgement.err);
          resolve(true);
        });
      });
...
module.exports = new Proxy(wrapper, {
  defineProperty: function defineProperty(original) {
    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }

    return Reflect.defineProperty.apply(Reflect, [Gun].concat(args));
  },
  getPrototypeOf: function getPrototypeOf(original) {
    for (var _len2 = arguments.length, args = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
      args[_key2 - 1] = arguments[_key2];
    }

    return Reflect.getPrototypeOf.apply(Reflect, [Gun].concat(args));
  },
  // Object.keys
  ownKeys: function ownKeys(original) {
    ...
    return Reflect.ownKeys.apply(Reflect, [Gun].concat(args));
  },
  get: function get(original, key) {
    ...
    return Reflect.get.apply(Reflect, [Gun, key].concat(args));
  },
  set: function set(original, key) {
    if (key == proxySymbol || key == thisProxySymbol) {
      return;
    }
    ...
    return Reflect.set.apply(Reflect, [Gun, key].concat(args));
  }
});
